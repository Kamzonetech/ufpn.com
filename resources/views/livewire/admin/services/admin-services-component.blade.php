    ...
    <div class="page-content" >
        ...
        <div class="row">
            <div class="col-lg-12" >
                <div class="card">
                    <div class="card-body">
                        <x-search-bar wire:model.live="searchTerm" placeholder="Search service by title or description" />
                        <x-spin-loader />
                        <div>
                            <div class="table-responsive">
                                <table class="table table-striped mb-0">
                                    <thead>
                                        <tr>
                                            <th><b>#</b></th>
                                            <th  class="desktopView"><b>Project Banner</b></th>
                                            <th><b>Project Title</b></th>
                                            <th  class="desktopView"><b>Project Description</b></th>
                                            <th><b>Action</b></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        @foreach ($services as $service)
                                            <tr>
                                                ...
                                                <td  class="desktopView">
                                                    <img src="{{ asset('admin/assets/images/services/'.$service->photo) }}" class="rounded" alt="" height="48">

                                                </td>
                                                <td>{{ $service->title}}</td>
                                                <td  class="desktopView">{!! Str::limit(strip_tags($service->description),120) !!}</td>
                                                <td>
                                                    <div class="dropdown"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            {{-- <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#viewNewsModal" wire:click="setService('{{ $service->slug }}')" href="#">View</a> --}}
