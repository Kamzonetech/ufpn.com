<div>
    <x-slot name="title">Post News</x-slot>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Post News</h4>
                    ...
                    <div class="card-body">
                        <form name="news-post" id="news-post" wire:submit.prevent="postNews(Object.fromEntries(new FormData($event.target)))" enctype="multipart/form-data">
                            <div>
                                ...
                                <div class="mb-3">
                                    <input type="checkbox" id="notifySubscribers" wire:model="notifySubscribers">
                                    <label for="notifySubscribers"><b>Notify Subscribers</b></label>
                                </div>

                                <button type="submit" class="btn btn-success waves-effect waves-light shadow-lg">
                                    <i wire:loading wire:target="postNews"
                                        class="bx bx-loader bx-spin font-size-16 align-middle me-2"></i> Post News
                                </button>
                        </form>
                    </div>
                </div>
