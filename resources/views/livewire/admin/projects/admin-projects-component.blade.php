                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mb-0">
                                    ...
                                    <thead>
                                        <tr>
                                            <th><b>#</b></th>
                                            <th  class="desktopView"><b>Client</b></th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($projects as $project)
                                            <tr>
                                                ...
                                                <td>{{ $project->title}}</td>
                                                <td  class="desktopView">{!! $project->description !!}</td>
                                                <td>{{ $project->date}}</td>
                                                <td>
                                                    <div class="dropdown"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item confirm-delete" wire:click="setActionId('{{ $project->id }}')" href="#">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
