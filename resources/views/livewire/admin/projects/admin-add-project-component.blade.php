    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        <form name="news-post" id="news-post" wire:submit.prevent="addProject(Object.fromEntries(new FormData($event.target)))" enctype="multipart/form-data">
                            <div>
                                ...
                                <div class="mb-3 position-relative">
                                    <label class="form-label" for="post_image"><b>Photo</b></label>
