        ...
        <section id="portfolio" class="portfolio section py-5">
          <div class="container">
            ...
            <div class="text-center mb-5">
              <h2 class="fw-bold text-primary">Our Portfolio</h2>
              <p class="text-muted">Explore our recent works — from web platforms to brand identities.</p>
            </div>
            ...
            @else
              ...
              <div class="text-center py-5">
                <h4 class="text-muted text-danger">No projects available at the moment.</h4>
              </div>
            @endif
