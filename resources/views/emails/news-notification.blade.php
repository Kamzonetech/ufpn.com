				...
				<td>
                    ...
                    <table class="row row-9" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #040525; color: #000000; width: 600px; margin: 0 auto;" width="600">
										<tbody>
											<tr>
														...
														<tr>
															<td class="pad">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 123.5px;"><img src="https://daimun.com.ng/admin/assets/images/logo.png" style="display: block; height: auto; border: 0; width: 100%;" width="150.5"></div>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="heading_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
                                                                ...
                                                                <img align="center" src="{{ $image }}" alt="News Image"><br><br>
                                                                {!! $description !!}

                                                                <a href="{{ route('news')}}" class="btn">Read More</a>
															</td>
														</tr>
													</table>
												</td>
														...
														<tr>
															<td class="pad" style="padding-bottom:15px;padding-left:15px;padding-right:15px;padding-top:20px;">
																<div style="color:#ffffff;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:right;mso-line-height-alt:16.8px;">
																	<p style="margin: 0;">Copyright © 2025 All rights reserved | Daimun Technologies Limited  <a href="{{ route('unsubscribe', ['email' => $subscriber->email, 'token' => $subscriber->unsubscribe_token]) }}" style="color: white"> Unsubscribe</a>.</p>
																</div>
															</td>
														</tr>
													</table>
